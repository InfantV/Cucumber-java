...
public void test01_popupHandle() throws InterruptedException{
	...
	@Test
	 public void test02_searchMobile(){
		try {
			...
			driver.findElement(By.xpath("(//input[@name='q'])[1]")).sendKeys("Samsung TV",Keys.ENTER);
	...
	@Test
	 public void test03_select() throws Exception{
		 WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
			wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//img[@class='UCc1lI'])[1]"))).click();
//			Window Handling
...
for(String x : allurl) {
	...
	@Test
	 public void test04_test() throws Exception{
		 WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
		WebElement start = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("(//div[@font='default-fk-font-m'])[4]")));
	 s = start.getText();
	 System.out.println(s);
	File f = new File("C:\\Users\\sujin\\Documents\\GIT folder\\TVName.xlsx");
	...
	try {
       ...
       File destination = new File("C:\\Users\\sujin\\Documents\\GIT folder\\TVImg.png");
